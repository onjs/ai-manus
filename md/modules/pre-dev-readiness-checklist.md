...
- [x] 部署拓扑锁定：`web/api/worker/worker-beat/sandbox/redis/mongo`（MVP 不含 ssrf）
- [x] 实时通道锁定：`全局摘要SSE + 会话详情SSE` 双通道
- [x] 实时改造执行清单：`16-realtime-sse-retrofit-checklist.md`

## 二、API 与任务拆解
- [x] 每模块独立 API Schema（8份）
- [x] 每模块独立开发任务清单（8份）
- [x] 契约样例文档
...
## 执行项详情
- 见 [14-execution-items-plan.md](/Users/zuos/code/github/ai-manus/md/modules/14-execution-items-plan.md)（E1~E5）。
