...
class BaseAgent(ABC):
    ...
    def __init__(
        ...
        tools: List[BaseToolkit] | None = None,
        model_kwargs: Optional[Dict[str, Any]] = None,
    ):
        self._agent_id = agent_id
        self._repository = agent_repository
        self.max_iterations = int(settings.AGENT_MODEL_MAX_ITERATIONS)
        self.max_retries = int(settings.AGENT_MODEL_MAX_RETRIES)
        self.retry_interval = float(settings.AGENT_MODEL_RETRY_INTERVAL_SECONDS)
